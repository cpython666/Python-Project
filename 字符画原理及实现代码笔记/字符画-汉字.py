...
pattern_image = Image.new('RGBA', pattern_size, color=(255, 255, 255,0))
# pattern_image = Image.new('RGB', pattern_size, color=(255, 255, 255))
pattern_draw = ImageDraw.Draw(pattern_image)
# 在花纹背景上绘制汉字，考虑填充
pattern_draw.text((-text_bbox[0] + padding, -text_bbox[1] + padding), hanzi, fill=(255, 255, 255,255), font=font)
...
pattern_image.show()
# 保存花纹图像
pattern_image.save("Hello,PyQt6~.png")